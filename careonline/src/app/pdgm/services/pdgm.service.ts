...
export class PDGMService {
  ...
  getpdgmToolPosition3OasisData(request): Observable<any> {
    return this.httpClient.post(this.apiURL + '/pdgmToolPosition3Oasis', request);
  }
  ...
  getM1850OasisOptions() {
    return {
      oasisCode: "M1850",
      oasisQuestion: "Current ability to move safely from bed to chair, or ability to turn and position self in bed if patient is bedfast.",
      functionalPoint: "Functional Point",
      oasisOptions: [{
        id: 0,
        flag: false,
